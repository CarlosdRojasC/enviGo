<template>
  <div class="page-container">
    <div class="page-header">
      <h1 class="page-title">Gestión de Conductores Globales</h1>
        ...
        <table class="data-table">
          ...
          <tbody>
            ...
            <tr v-else-if="drivers.length === 0">
              <td colspan="5" class="empty-row">No se encontraron conductores.</td>
            </tr>
            <tr v-else v-for="driver in drivers" :key="driver._id">
              ...
              <td><span class="shipday-id">{{ driver.shipday_driver_id || 'N/A' }}</span></td>
              <td>
...
<style scoped>
/* (Puedes usar los estilos de la respuesta anterior, son compatibles) */
.page-container { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 1400px; margin: 0 auto; }
...
.btn-action.toggle { padding: 6px 10px; border-radius: 6px; border: 1px solid #d1d5db; background: white; cursor: pointer; font-size: 12px; }
</style>