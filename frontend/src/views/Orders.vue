  ...
  <style>
    ...
    * {
    ...
    .envigo-code {
      ...
      padding: 2mm 3mm;
      border-radius: 4px;
      box-shadow: 0 1px 3px rgba(139, 197, 63, 0.3);
    }
    ...
    /* Distribución en página A4: 2 etiquetas por fila */
    .label:nth-child(4n) {
        ...
        <div class="label-content">
          <div class="order-section">
            ...
            <div class="info-line">
              ...
              <div class="info-value">#${label.order_number}</div>
            </div>
            <div class="info-line">
              <div class="info-label">Cliente:</div>
              <div class="info-value">${label.customer_name}</div>
            </div>
            <div class="info-line">
              <div class="info-label">Teléfono:</div>
              <div class="info-value">${label.customer_phone || 'No disponible'}</div>
            </div>
            <div class="info-line">
              <div class="info-label">Monto:</div>
              <div class="info-value">$${label.total_amount ? new Intl.NumberFormat('es-CL').format(label.total_amount) : 'N/A'}</div>
            </div>
          </div>
          ...
          ${label.notes ? `
            <div class="notes-section">
              ...
              <div class="notes-text">${label.notes}</div>
            </div>
          ` : ''}
        </div>
      </div>
